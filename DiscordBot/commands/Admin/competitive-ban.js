...
module.exports = {
    commandInfo: {
        name: "competitive-ban",
        description: "Ban a player from competitive/arena modes for a specified duration",
        options: [
            {
                name: "username",
    ...
    execute: async (interaction) => {
        ...
        const reason = interaction.options.getString("reason") || "Competitive violation";
        ...
        try {
            ...
            if (existingBan) {
                const errorEmbed = new MessageEmbed()
                    ...
                    .setDescription(`**${username}** is already banned from competitive modes.`)
            ...
            const successEmbed = new MessageEmbed()
                .setTitle("✅ Competitive Ban Applied")
                .setDescription(`**${user.username}** has been banned from competitive modes.`)
            ...
            console.error("Error in competitive-ban command:", error);
